...
public class Aerolinea
{
    ...
    public Vuelo getVuelo( String codigoRuta, String fechaVuelo )
    {
        ...
        {
            if( v == null ) continue;
            if( v.getRuta( ) != null && codigoRuta.equals( v.getRuta( ).getCodigoRuta( ) ) && fechaVuelo.equals( v.getFecha( ) ) )
                return v;
        }
        return null;
    }
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        // Verificar que no haya choque horario con otros vuelos asignados al mismo avión
        for( Vuelo v : vuelos )
        {
            if( v == null ) continue;
            if( v.getAvion( ) != null && v.getAvion( ).equals( avionSeleccionado ) && v.getFecha( ).equals( fecha ) )
            {
                // choque -> error
    ...
    public String consultarSaldoPendienteCliente( String identificadorCliente )
    {
        ...
        double suma = 0.0;
        // Suponemos que Cliente tiene un método getTiquetesSinUsar() que devuelve Collection<Tiquete>
